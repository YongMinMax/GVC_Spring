...
@Configuration
@MapperScan(value="com.waveware.mapper.master", sqlSessionFactoryRef = "masterSqlSessionFactory")
...
public class MasterDataBaseConfig
{
	...
	public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDataSource") DataSource masterDataSource, ApplicationContext applicationContext) throws Exception{
		...
		sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:com/waveware/mapper/master/*.xml"));
